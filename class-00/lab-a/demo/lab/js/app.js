...
function displayPics(){
  ...
  //var is function scope, and const are block scope

  // let is a variable declaration that is block scope it only applies to the while loop,
  //where var applies to the entire function of where the variable was declared in function of displaypics()
